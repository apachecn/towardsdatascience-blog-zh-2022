...
[](https://medium.com/geekculture/labeling-data-with-label-studio-on-sagemaker-e4b2d1b562f7) [## 使用 SageMaker 上的 Label Studio 标注数据

### 在笔记本实例上部署 Label Studio 的分步指南

medium.com](https://medium.com/geekculture/labeling-data-with-label-studio-on-sagemaker-e4b2d1b562f7) 
...
[](/unhappy-about-your-time-series-anomalies-synthesize-them-908495475947) [## 对你的时间序列异常不满意？合成他们！

### 生成您自己的具有真实异常的多元时间序列数据集

towardsdatascience.com](/unhappy-about-your-time-series-anomalies-synthesize-them-908495475947) 
