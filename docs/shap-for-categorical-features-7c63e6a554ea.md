...
[](/shap-for-categorical-features-with-catboost-8315e14dac1) [## 使用 CatBoost 实现分类特征的 SHAP

### 避免对分类要素的 SHAP 值进行后处理

towardsdatascience.com](/shap-for-categorical-features-with-catboost-8315e14dac1) 
