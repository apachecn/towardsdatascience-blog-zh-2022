...
我们不会重建稳定扩散，但我们会在这一集结束时制作一些玩具模型来展示一切是如何工作的。除了这篇文章，我还创建了一个配套的 [Github 库](https://github.com/Jmkernes/Diffusion)来收集所有与扩散相关的东西。在几个点上，我会参考回购的更多细节。截至 2022 年底，有两件事你会想看看:
...
![](img/63eb94fd1702062e2ae60f83e229c940.png)
