...
[](https://www.kaggle.com/code/currie32/summarizing-text-with-amazon-reviews/notebook) [## 用亚马逊评论总结文本

### 使用 Kaggle 笔记本探索和运行机器学习代码|使用来自亚马逊美食评论的数据

www.kaggle.com](https://www.kaggle.com/code/currie32/summarizing-text-with-amazon-reviews/notebook) 
...
[](https://github.com/aymanehachcham/GPT2_Text_Summarization) [## GitHub-aymanehachham/gp T2 _ Text _ summary

### 这个项目的重点是微调 GPT2 模型，在公共 Amanzon 评论数据集上执行文本摘要…

github.com](https://github.com/aymanehachcham/GPT2_Text_Summarization) [](https://colab.research.google.com/drive/1iDhg8ss-BW0ZpzL-umJhd9XAm7xUlz-g?usp=sharing#scrollTo=rinybKnGJLpY) [## 谷歌联合实验室

### 编辑描述

colab.research.google.com](https://colab.research.google.com/drive/1iDhg8ss-BW0ZpzL-umJhd9XAm7xUlz-g?usp=sharing#scrollTo=rinybKnGJLpY) 
