...
[](/creating-a-better-dashboard-with-python-dash-and-plotly-80dfb4269882) [## 使用 Python、Dash 和 Plotly 创建更好的仪表板

### 让您开始使用 python 轻松创建仪表板的演练。

towardsdatascience.com](/creating-a-better-dashboard-with-python-dash-and-plotly-80dfb4269882) 
...
[](https://github.com/brad-darksbian/fed_dashboard) [## GitHub-Brad-darksbian/fed _ dashboard:一个简单的 Dash 和 Plotly 仪表板，用于查看和比较…

### 查看联邦经济数据的简单仪表板。该系统使用联邦经济数据中包含的 CSV 文件…

github.com](https://github.com/brad-darksbian/fed_dashboard) 

使用 pull_fed_data.py 脚本更新数据的一个 Fed API 键是不错的，但不是特别需要。

过去，我写了一整篇关于获取这些数据的文章。如果感兴趣，请查看:

[](/using-python-to-get-and-store-federal-economic-data-11444317ecfb) [## 使用 Python 获取和存储联邦经济数据

### 从数据获取流程的一些最初步骤开始数据之旅。

towardsdatascience.com](/using-python-to-get-and-store-federal-economic-data-11444317ecfb) 
