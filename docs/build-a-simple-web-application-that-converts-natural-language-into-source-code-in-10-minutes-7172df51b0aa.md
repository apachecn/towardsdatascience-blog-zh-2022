...
该模型的一个主要优点是，它可以与**少量发射**或**零发射学习**一起使用，这大大缩短和简化了事情，不再需要长时间的数据准备和训练阶段。
...
![](img/b88c3cd3123f29f160a63dbc28beb1f3.png)
...
*输入*、*输出*和*状态*依赖关系将允许我们管理由显示字段上的事件触发的回调。
...
![](img/34a533ad89a1bfaeb91f733eaba6e87b.png)
