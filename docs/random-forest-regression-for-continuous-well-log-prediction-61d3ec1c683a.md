...
[](/random-forest-for-lithology-classification-from-well-log-data-4a1380ef025b) [## 用于测井数据岩性分类的随机森林

### 用机器学习对地下进行分类

towardsdatascience.com](/random-forest-for-lithology-classification-from-well-log-data-4a1380ef025b) 
