...
[](https://www.ibm.com/cloud/learn/neural-networks) [## 什么是神经网络？
...
[](/identifying-and-handling-missing-well-log-data-prior-to-machine-learning-5fa1a3d0eb73) [## 在机器学习之前识别和处理缺失的测井数据

### 从探索性数据分析到利用测井数据进行机器学习系列文章的第 2 部分

towardsdatascience.com](/identifying-and-handling-missing-well-log-data-prior-to-machine-learning-5fa1a3d0eb73) 
...
**[](/random-forest-regression-for-continuous-well-log-prediction-61d3ec1c683a) [## 连续测井预测的随机森林回归

### 应用于岩石物理学的流行机器学习算法综述

towardsdatascience.com](/random-forest-regression-for-continuous-well-log-prediction-61d3ec1c683a) 
