...
towardsdatascience.com](/stat-stories-multivariate-transformation-for-statistical-distributions-7077a374b3b4) [](/stat-stories-normalizing-flows-as-an-application-of-variable-transformation-7b7beda7b03b) [## Stat Stories:将流程规范化作为变量转换的应用

### 易处理分布的生成模型

towardsdatascience.com](/stat-stories-normalizing-flows-as-an-application-of-variable-transformation-7b7beda7b03b) 
...
[](/stat-stories-why-is-moment-generating-function-important-25bbc17dad68) [## 统计故事:为什么矩母函数很重要？
